...
const ruleCreator = ESLintUtils.RuleCreator((name) => `https://github.com/obsidianmd/eslint-plugin/blob/master/docs/rules/commands/${name}.md`);
export default ruleCreator({
    ...
    meta: {
        ...
        messages: {
            hotkeys: "Don't provide a default hotkey, as they might conflict with other hotkeys the user has already set, or that are included with Obsidian by default.",
        },
        schema: [],
    },
    defaultOptions: [],
