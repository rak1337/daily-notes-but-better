...
function isPluginType(type, services) {
...
export default ruleCreator({
    ...
    meta: {
        type: "problem",
        docs: {
            description: "Disallow anti-patterns when passing a component to MarkdownRenderer.render to prevent memory leaks.",
        },
        schema: [],
        messages: {
            avoidPluginComponent: "Avoid using the main plugin instance as a component. Its lifecycle is too long, which can cause memory leaks.",
            avoidNewComponent: "Do not pass a `new Component()` directly. Store it in a variable to ensure its `unload()` method can be called.",
        },
    },
    defaultOptions: [],
    create(context) {
