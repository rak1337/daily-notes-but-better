...
export default ruleCreator({
    ...
    meta: {
        type: "suggestion",
        docs: {
            description: "Disallow type casting to TFile or TFolder, suggesting instanceof checks instead.",
        },
        schema: [],
        messages: {
            avoidCast: "Avoid casting to '{{typeName}}'. Use an 'instanceof {{typeName}}' check to safely narrow the type.",
        },
