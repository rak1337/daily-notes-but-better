...
const VISITORS = {
    ObjectExpression(node, context) {
        ...
        for (const prop of node.properties) {
            if (prop.type === "Property") {
                const keyName = (0, utils_2.getStaticPropertyName)(prop, context);
                if (keyName != null) {
    ...
    Identifier(node, context) {
        const init = (0, utils_1.findInitNode)(context, node);
        if (init == null) {
            const evalData = (0, utils_1.getStaticValue)(context, node);
            if (evalData != null) {
                return {
                    data: evalData.value,
                    children: EMPTY_MAP,
        ...
        function getWriteProps(id) {
            ...
            let mem = id.parent;
            while (mem) {
                const name = (0, utils_2.getStaticPropertyName)(mem, context);
                if (name == null) {
                    break;
                }
                results.push(name);
    ...
    MemberExpression(node, context) {
        ...
        const propName = (0, utils_2.getStaticPropertyName)(node, context);
        if (propName == null) {
            return UNKNOWN_PATH_DATA;
        }
    ...
    CallExpression(node, context) {
        ...
        if (!evalData) {
            if (node.callee.type === "MemberExpression" &&
                ...
                (0, utils_2.getStaticPropertyName)(node.callee, context) === "resolve") {
